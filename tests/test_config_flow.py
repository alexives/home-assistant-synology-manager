"""Tests for the Synology Manager config flow."""
...
async def test_form_success(hass: HomeAssistant) -> None:
    ...
    with patch(
        "custom_components.synology_manager.config_flow.validate_input",
...
async def test_form_invalid_auth(hass: HomeAssistant) -> None:
    ...
    from custom_components.synology_manager.config_flow import InvalidAuth
...
async def test_form_cannot_connect(hass: HomeAssistant) -> None:
    ...
    from custom_components.synology_manager.config_flow import CannotConnect
